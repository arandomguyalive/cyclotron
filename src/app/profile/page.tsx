    ...
    <div className="min-h-screen bg-cyber-black text-white pb-24">
      ...
      <div className="px-4 -mt-12 relative z-10">
        ...
        <div className="flex mt-4 gap-4">
          <button className="flex-1 py-2 border-b-2 border-cyber-blue text-cyber-blue flex justify-center">
            <Grid className="w-5 h-5" />
          </button>
          <button className="flex-1 py-2 border-b-2 border-transparent text-gray-500 flex justify-center">
